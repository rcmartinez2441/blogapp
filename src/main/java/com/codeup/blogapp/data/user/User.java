...
public class User {
    ...
    @OneToMany(mappedBy = "user", cascade = CascadeType.REMOVE, orphanRemoval = true) //Cascade means If I were to delete a user, it would delete any posts that has that user ID
